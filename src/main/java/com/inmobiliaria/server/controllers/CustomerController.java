...
public class CustomerController {
    ...
    public ResponseEntity<ResponseDto> postCustomer(@RequestBody Customer customer) throws CustomException {
        ...
        Customer customerRegitered = customerServiceImpl.registerCustomer(customer);
       
        if (customerRegitered == null) throw new CustomException(
    ...
    public String getCustomerList(@RequestParam String param) {
        return new String();
    }
